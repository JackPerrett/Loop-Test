...
export async function runContentCheck(page) {
  ...
  if (!meta.title || meta.title.trim().length === 0) {
    issues.push({
      ...
      norm: "Nielsen Heuristic #1 (Visibility of System Status) / SEO best practice",
      affectedElements: 1,
    });
  ...
  if (h1Count === 0) {
    issues.push({
      ...
      norm: 'HTML5 semantics / WCAG best practice',
      affectedElements: 1,
    });
  } else if (h1Count > 1) {
    issues.push({
      ...
      norm: 'HTML5 semantics best practice',
  ...
  if (vagueLinks > 0) {
    issues.push({
      ...
      norm: 'WCAG 2.4.4 Link Purpose (In Context) / plain-language best practice',
  ...
  if (!hasNav) {
    issues.push({
      ...
      norm: 'WCAG 1.3.1 Info and Relationships / semantic HTML best practice',
      affectedElements: 1,
    });
  }
  ...
  if (unsafeBlankLinks > 0) {
    issues.push({
      ...
      norm: 'Web security & performance best practice',
